...
################################################################
# This is a generated script based on design: custom_eth
#
...
# source custom_eth_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# eth_axis_patgen, axis_rx_to_bram
...
\
  ...
  # Create instance: rst_ps8_0_71M, and set properties
  set rst_ps8_0_71M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_71M ]
  ...
  # Create instance: eth_axis_patgen_0, and set properties
  set block_name eth_axis_patgen
  set block_cell_name eth_axis_patgen_0
  if { [catch {set eth_axis_patgen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $eth_axis_patgen_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  set_property -dict [ list \
   CONFIG.CLK_DOMAIN {custom_eth_zynq_ultra_ps_e_0_2_pl_clk0} \
 ] [get_bd_intf_pins /eth_axis_patgen_0/txc]

  set_property -dict [ list \
   CONFIG.CLK_DOMAIN {custom_eth_zynq_ultra_ps_e_0_2_pl_clk0} \
 ] [get_bd_intf_pins /eth_axis_patgen_0/txd]
  ...
  # Create instance: axis_rx_to_bram_0, and set properties
  set block_name axis_rx_to_bram
  set block_cell_name axis_rx_to_bram_0
  if { [catch {set axis_rx_to_bram_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_rx_to_bram_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_71M/slowest_sync_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins axis_rx_to_bram_0/axis_clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins eth_axis_patgen_0/axis_clk]
  connect_bd_net -net axi_ethernet_0_interrupt [get_bd_pins axi_ethernet_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tdata [get_bd_pins axi_ethernet_0/m_axis_rxd_tdata] [get_bd_pins axis_rx_to_bram_0/s_axis_tdata]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tkeep [get_bd_pins axi_ethernet_0/m_axis_rxd_tkeep] [get_bd_pins axis_rx_to_bram_0/s_axis_tkeep]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tlast [get_bd_pins axi_ethernet_0/m_axis_rxd_tlast] [get_bd_pins axis_rx_to_bram_0/s_axis_tlast]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tvalid [get_bd_pins axi_ethernet_0/m_axis_rxd_tvalid] [get_bd_pins axis_rx_to_bram_0/s_axis_tvalid]
  connect_bd_net -net axi_ethernet_0_m_axis_rxs_tdata [get_bd_pins axi_ethernet_0/m_axis_rxs_tdata] [get_bd_pins axis_rx_to_bram_0/s_axis_rxs_tdata]
  connect_bd_net -net axi_ethernet_0_m_axis_rxs_tkeep [get_bd_pins axi_ethernet_0/m_axis_rxs_tkeep] [get_bd_pins axis_rx_to_bram_0/s_axis_rxs_tkeep]
  connect_bd_net -net axi_ethernet_0_m_axis_rxs_tlast [get_bd_pins axi_ethernet_0/m_axis_rxs_tlast] [get_bd_pins axis_rx_to_bram_0/s_axis_rxs_tlast]
  connect_bd_net -net axi_ethernet_0_m_axis_rxs_tvalid [get_bd_pins axi_ethernet_0/m_axis_rxs_tvalid] [get_bd_pins axis_rx_to_bram_0/s_axis_rxs_tvalid]
  ...
  connect_bd_net -net axi_ethernet_0_s_axis_txc_tready [get_bd_pins axi_ethernet_0/s_axis_txc_tready] [get_bd_pins eth_axis_patgen_0/txc_tready]
  connect_bd_net -net axi_ethernet_0_s_axis_txd_tready [get_bd_pins axi_ethernet_0/s_axis_txd_tready] [get_bd_pins eth_axis_patgen_0/txd_tready]
  connect_bd_net -net axis_rx_to_bram_0_m_axis_eth_tdata [get_bd_pins axis_rx_to_bram_0/m_axis_eth_tdata] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net eth_axis_patgen_0_rxd_tready [get_bd_pins axis_rx_to_bram_0/s_axis_tready] [get_bd_pins axi_ethernet_0/m_axis_rxd_tready]
  connect_bd_net -net eth_axis_patgen_0_rxs_tready [get_bd_pins axis_rx_to_bram_0/s_axis_rxs_tready] [get_bd_pins axi_ethernet_0/m_axis_rxs_tready]
  connect_bd_net -net eth_axis_patgen_0_txc_tdata [get_bd_pins eth_axis_patgen_0/txc_tdata] [get_bd_pins axi_ethernet_0/s_axis_txc_tdata]
  connect_bd_net -net eth_axis_patgen_0_txc_tkeep [get_bd_pins eth_axis_patgen_0/txc_tkeep] [get_bd_pins axi_ethernet_0/s_axis_txc_tkeep]
  connect_bd_net -net eth_axis_patgen_0_txc_tlast [get_bd_pins eth_axis_patgen_0/txc_tlast] [get_bd_pins axi_ethernet_0/s_axis_txc_tlast]
  connect_bd_net -net eth_axis_patgen_0_txc_tvalid [get_bd_pins eth_axis_patgen_0/txc_tvalid] [get_bd_pins axi_ethernet_0/s_axis_txc_tvalid]
  connect_bd_net -net eth_axis_patgen_0_txd_tdata [get_bd_pins eth_axis_patgen_0/txd_tdata] [get_bd_pins axi_ethernet_0/s_axis_txd_tdata]
  connect_bd_net -net eth_axis_patgen_0_txd_tkeep [get_bd_pins eth_axis_patgen_0/txd_tkeep] [get_bd_pins axi_ethernet_0/s_axis_txd_tkeep]
  connect_bd_net -net eth_axis_patgen_0_txd_tlast [get_bd_pins eth_axis_patgen_0/txd_tlast] [get_bd_pins axi_ethernet_0/s_axis_txd_tlast]
  connect_bd_net -net eth_axis_patgen_0_txd_tvalid [get_bd_pins eth_axis_patgen_0/txd_tvalid] [get_bd_pins axi_ethernet_0/s_axis_txd_tvalid]
  connect_bd_net -net rst_ps8_0_71M_peripheral_aresetn [get_bd_pins rst_ps8_0_71M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_0/axi_rxd_arstn] [get_bd_pins axi_ethernet_0/axi_txc_arstn] [get_bd_pins axi_ethernet_0/axi_rxs_arstn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axis_rx_to_bram_0/axis_aresetn] [get_bd_pins eth_axis_patgen_0/axis_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axis_rx_to_bram_0/capture_en]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconstant_3/dout] [get_bd_pins eth_axis_patgen_0/enable]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_71M/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x82000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force

...
################################################################
# This is a generated script based on design: ip_encapsulator_bd
#
...
# source ip_encapsulator_bd_script.tcl
...
set design_name ip_encapsulator_bd
...
\
  ...
  # Create instance: ip_encapsulator_0, and set properties
  set block_name ip_encapsulator
  set block_cell_name ip_encapsulator_0
  if { [catch {set ip_encapsulator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ip_encapsulator_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.BRAM_ADDR_WIDTH {11} \
    CONFIG.BRAM_DATA_WIDTH {256} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins ip_encapsulator_0/s_axi]
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins ip_encapsulator_0/bram_dout_b]
  connect_bd_net -net ip_encapsulator_0_bram_addr_b [get_bd_pins ip_encapsulator_0/bram_addr_b] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net ip_encapsulator_0_bram_clk_b [get_bd_pins ip_encapsulator_0/bram_clk_b] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net ip_encapsulator_0_bram_en_b [get_bd_pins ip_encapsulator_0/bram_en_b] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins ip_encapsulator_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins ip_encapsulator_0/rstn]
  ...
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ip_encapsulator_0/s_axi/reg0] -force
